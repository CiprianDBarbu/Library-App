...
namespace DeputRapid.Models.MyValidation
{
            ...
            switch (s)
            {
                case '1':
                    if (!(contact.GenderType.Equals(Gender.Male) && contact.BirthYear >= 1900 && contact.BirthYear <= 1999))
                        return new ValidationResult("S  part  is  not  valid!"); break;
                case '2':
                ...
                case '6':
                    if (!(contact.GenderType.Equals(Gender.Female) && contact.BirthYear >= 2000 && contact.BirthYear <= 2099))
                        return new ValidationResult("S  part  is  not  valid!"); break;
                case '7':
                    if (!(contact.GenderType.Equals(Gender.Male) && contact.Resident.Equals(true))) return new ValidationResult("S  part  is  not  valid!");
                    break;
                case '8':
                    if (!(contact.GenderType.Equals(Gender.Female) && contact.Resident.Equals(true))) return new ValidationResult("S  part  is  not  valid!");
                    break;
